...
public class ProductServiceImpl implements ProductService {
    ...
    public List<RecommenderDto> findSimilarProducts(String queryDescription) {
        ...
        allProducts.removeIf(product -> product.getDescription().equals(queryDescription));
        ...
        // Create a matrix of vectors for all products
        List<Vector> productVectors = new ArrayList<>();
        for (Product product : allProducts) {
            Vector productVector = convertToVector(product.getDescription(), dictionary, idfValues);
            productVectors.add(productVector);
        }

        // Create a vector for the query description
    ...
    private Vector convertToVector(String input, Map<String, Integer> dictionary, Map<String, Double> idfValues) {
